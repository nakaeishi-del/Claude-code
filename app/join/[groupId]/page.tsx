      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
        ...
        {error ? (
          ...
          <>
            ...
            <p className="text-2xl font-bold text-[#4ECDC4] my-4">{group.name}</p>
            {group.description && (
            ...
            {!isLoggedIn ? (
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="block w-full py-3 bg-[#4ECDC4] text-white rounded-xl text-sm font-semibold hover:bg-[#3ba89e] transition-colors"
                >
                  ログインして参加
                </Link>
                <Link
              ...
              <>
                ...
                <button
                  onClick={handleJoin}
                  disabled={joining}
                  className="w-full py-3 bg-[#4ECDC4] text-white rounded-xl text-sm font-semibold hover:bg-[#3ba89e] disabled:opacity-60 transition-colors"
                >
